...
import bit from "../../static/img-about/imgBitcoin.jpg";
import bit2 from "../../static/img-about/imgB2.jpg";
  ...
  addImages() {
    ...
    this.imageStore = this.images.map((img) => {
      ...
      let texture = new THREE.TextureLoader().load(img.src, (t)=>{
        this.countTextures++
        console.log(this.countTextures)
        if(this.countTextures === this.images.length) {
          this.onload()
        }
      });
      let texture2 = new THREE.TextureLoader().load(bit2);
